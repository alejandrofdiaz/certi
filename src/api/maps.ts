...
function suckDataFromGooglePlace(place: google.maps.places.PlaceResult) {
...
function goggleImageAsALink(
  ...
  return new Promise((resolve, reject) => {
    _axios
      .all([
        axios.get(url_map, { responseType: 'arraybuffer' }),
        axios.get(url_street_view, { responseType: 'arraybuffer' })
      ])
      .then(
