    ...
    return (
      <form id="address">
          ...
          <div className="field-body">
            ...
            <div className="field">
              <div className="control has-icons-left has-icons-right">
                <input className="input" type="text" placeholder="Provincia" value="" />
        ...
        <div className="field">
          ...
          <div className="control has-icons-left has-icons-right">
            <input className="input" type="text" placeholder="municipio válido" value="" />
            <span className="icon is-small is-left">
        ...
        <div className="field is-horizontal direction-form">
          ...
          <div className="field-body">
            <div className="field direction-form__address">
              <div className="control has-icons-left has-icons-right">
                <input className="input" type="text" placeholder="dirección válida" value="" />
                <span className="icon is-small is-left">
                  <i className="fa fa-map-marker" />
                </span>
              </div>
            ...
            <div className="field direction-form__number">
              <div className="control has-icons-left has-icons-right">
                <input className="input" type="number" placeholder="número" value="" />
                <span className="icon is-small is-left">
                  <i className="fa fa-map-marker" />
                </span>
              </div>
